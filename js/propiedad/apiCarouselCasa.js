...
// document.getElementById('container-propiedad-depa').innerHTML = data.map(data => 
//     `<li class="splide__slide" style="width: 550px">	  
//         <div class="item">
//             <div class="card" style="width: 20rem;margin: 0px 10px 0px 10px">
//             <span class="uf-item-price">${data.types} / ${data.operation}</span>
...
// document.getElementById('container-propiedad-lista-casa').innerHTML = data.map(data => 
//         ` <div class="item">
...
//               Casa Amoblada, excelente ubicación
//             </h4>
//             <small class="card-text-small"
